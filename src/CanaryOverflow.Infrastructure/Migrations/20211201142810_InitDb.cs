        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentedById = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Text = table.Column<string>(type: "text", nullable: true),
                    AskedById = table.Column<Guid>(type: "uuid", nullable: false),
                    AnswerId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VotedById = table.Column<Guid>(type: "uuid", nullable: false),
                    Vote = table.Column<short>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionVotes", x => new { x.QuestionId, x.VotedById });
                    table.ForeignKey(
                        name: "FK_QuestionVotes_AspNetUsers_VotedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionVotes_VotedById",
                table: "QuestionVotes",
                column: "VotedById");
